	...
	protected void configure(HttpSecurity http) throws Exception {
        ...
        for (SECTION section : SECTION.values()) {
        	if (section != SECTION.USERS) {
	            ...
	            ((AuthorizedUrl)r.regexMatchers(HttpMethod.GET, new String[]{"/" + section.get() + "_sort.+"})).permitAll();
        ...
        // Para usuario normal
        ((AuthorizedUrl)r.regexMatchers(HttpMethod.GET, new String[]{"/booksCart\\??"})).hasRole(Constants.ROLE_USER);
