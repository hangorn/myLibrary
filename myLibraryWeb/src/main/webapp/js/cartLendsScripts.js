...
if(lendBookButton != null) {
	lendBookButton.onclick = lendBook;
}
...
document.getElementById("acceptLendBook").onclick = function() {
	...
	form.action = lendsLink + "_cartBooks";
	form.method = "post";
	document.getElementById("lendBookFormBackground").appendChild(form);
	
	var params = [
		["libro.id", "1"],
		["usuario.username",usernameSelected],
		["fecha", document.getElementById("lendDate").value],
